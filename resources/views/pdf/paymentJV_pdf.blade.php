...
<body>
    ...
    <table style="width: 100%; ">
        <tr>
            ...
            <td style="padding: 4px 10px; text-align: left;">
                <strong>Reference No.:</strong> {{ $data['reference_no'] ?? '_________' }}
            </td>
        </tr>
    </table>
    {{-- <div class="info-row">
        <div><strong><span class="label">Payment Type : </span></strong>{{ $data['payment_type'] }}</div>
        <div><strong><span class="label">Reference No. : </span></strong>{{ $data['reference_no'] ?? '_________' }}
        </div>
    </div> --}}
