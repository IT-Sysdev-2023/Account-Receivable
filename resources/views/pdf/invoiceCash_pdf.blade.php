...
<head>
    ...
    <style>
        ...
        .document-table-three th,
        .document-table-three td {
...
<body>
    ...
    <table class="document-table-three">
        <tbody>
            <tr>
                <td><strong>Payment No.:</strong> {{ $data['payment_no'] }}</td>
                <td><strong>Payment Type:</strong> {{ $data['payment_type'] }}</td>
                <td><strong>Amount Paid:</strong> {{ $data['amount_paid'] }}</td>
            </tr>
        </tbody>
    </table>
