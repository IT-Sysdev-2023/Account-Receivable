...
<head>
    <meta charset="UTF-8">
    <title>Adjustment Prooflist</title>
    <style>
        body {
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th class="col-adjtype">ADJ. TYPE</th>
                    <th class="col-adjapply">ADJ. APPLY</th>
            ...
            <tbody>
                @foreach ($group['adjustments'] as $adjustment)
                    <tr>
                        <td class="text-center">{{ $adjustment['adjustment_no'] }}</td>
                        <td class="text-center">
                            {{ \Carbon\Carbon::parse($adjustment['transaction_date'])->format('m/d/Y') }}</td>
                        <td class="text-center">{{ $adjustment['type'] }}</td>
                        <td class="text-center">{{ $adjustment['apply_to'] }}</td>
                        <td class="text-center">{{ $adjustment['invoice_no'] }}</td>
                        <td>{{ $adjustment['adjustment_reason'] }}</td>
                        <td class="col-amount">{{ number_format($adjustment['amount'], 2) }}</td>
                    </tr>
                @endforeach
