            ...
            <form @submit.prevent="submit">
                <div class="px-8 py-6">
                    ...
                    <div class="flex flex-col gap-2">
                            ...
                            <div class="flex gap-4">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <span class="text-sm font-medium z-10"
                                            >By Customer Code</span
                                        >
                                    </div>
                                </label>

                                <!-- By Customer Type Option -->
                                <label
                                    class="inline-flex items-center cursor-pointer group"
                                >
                                    <input
                        ...
                        <div
                            v-if="form.customer_type === 'By Customer Code'"
                        ...
                        <div
                            v-if="form.customer_type === 'By Customer Type'"
                            class="grid grid-cols-3 gap-2"
                        >
                            <div class="space-y-1 col-span-3">
                                <DropdownInput
                                    label="Customer Type"
                                    v-model="form.customer_select_type"
                                    :options="[
                                        'Booking',
                                        'Concession',
                                        'External',
                                    ...
                                    :message="form.errors.customer_select_type"
...
const previewInvoice = async () => {
    try {
        ...
        apiRoute.value = "statementOfAccountSummary";
...
const submit = () => {
    ...
    form.post(route("statementOfAccountSummary"), {
        onSuccess: () => {
