            ...
            <form @submit.prevent="submit">
                <div class="px-8 py-6">
                    ...
                    <div class="flex flex-col gap-2">
                        <!-- Customer Selection -->
                        <div class="flex flex-col gap-2">
                            <label class="block text-md font-bold">CUSTOMER</label>
                            <div class="flex gap-4">
                                <!-- All Customer Option -->
                                <label class="inline-flex items-center cursor-pointer group">
                                    <input type="radio" v-model="form.customer_type" value="All Customer"
                                        class="hidden peer" />
                                    <div class="relative flex items-center justify-center p-2">
                                        ...
                                        <span class="text-sm font-medium z-10">All Customer</span>
                                    </div>
                                </label>

                                <!-- By Customer Option -->
                                <label class="inline-flex items-center cursor-pointer group">
                                    <input type="radio" v-model="form.customer_type" value="By Customer"
                                        class="hidden peer" />
                                    <div class="relative flex items-center justify-center p-2">
                                        <!-- Hover circle -->
                                        <div class="absolute -inset-1 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-200 bg-[var(--color-border)]/40"
                                        ...
                                        <span class="text-sm font-medium z-10">By Customer</span>
                                    </div>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col gap-2">
                            <label class="block text-md font-lg font-bold">RECEIPT DATE</label>
                        </div>

                        <!-- Date Range -->
                        <div class="grid grid-cols-2 gap-2">
                            <div class="space-y-1">
                                <label class="block text-sm font-medium text-[var(--color-text-secondary)] mb-2">Start
                                    Date</label>
                        ...
                        <!-- Add this right after the Date Range section -->
                        <div class="flex flex-col gap-2">
                            <!-- Sort Options -->
                            <div class="flex flex-col gap-2">
                                <label class="block text-md font-bold">SORT OPTIONS</label>
                                <div class="flex gap-4">
                                    <!-- Sort by Date -->
                                    <label class="inline-flex items-center cursor-pointer">
                                        <input type="radio" v-model="form.sortOption" value="Date"
                                            class="hidden peer" />
                                        <div class="relative flex items-center justify-center p-2">
                                            <!-- Hover circle -->
                                            <div class="absolute -inset-1 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-200 bg-[var(--color-border)]/40"
                                            ...
                                            <span class="text-sm font-medium z-10">Sort by Date</span>
                                        </div>
                                    </label>

                                    <!-- Sort by Document No -->
                                    <label class="inline-flex items-center cursor-pointer">
                                        <input type="radio" v-model="form.sortOption" value="Document No"
                                            class="hidden peer" />
                                        <div class="relative flex items-center justify-center p-2">
                                            <!-- Hover circle -->
                                            <div class="absolute -inset-1 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-200 bg-[var(--color-border)]/40"
                                            ...
                                            <span class="text-sm font-medium z-10">Sort by Document No</span>
                                        </div>
                                    </label>
                                </div>
                            </div>
...
const previewInvoice = async () => {
    try {
        ...
        apiRoute.value = "overageShortage";
...
const submit = () => {
    ...
    form.post(route("overageShortage"), {
        onSuccess: () => {
