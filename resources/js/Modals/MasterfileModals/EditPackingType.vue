            ...
            <form @submit.prevent="submit">
                ...
                <div v-else class="px-8 space-y-6">
                    <div class="flex flex-col md:flex-row gap-6">
                        ...
                        >
                            ...
                            <TextInput
                                label="Packing Type"
                                v-model="form.packing_type"
                                type="text"
                                :message="form.errors.packing_type"
                                class="md:col-span-2"
                            />
                        </div>
                    </div>
                ...
                >
                    <div class="flex items-center">
                        <p class="text-xs">
                            Updated By : {{ props.pt.created_by }}
                        </p>
                    </div>
...
watch(
    ...
    (newVal) => {
        ...
        if (newVal && props.pt) {
            form.sequence_no = props.pt.sequence_no;
            form.packing_type = props.pt.packing_type;
...
const submit = () => {
    form.put(route("editPackingType", props.pt.id), {
        onSuccess: () => {
            form.reset();
            emit("closeSuccess");
        },
