            ...
            <form @submit.prevent="submit">
                ...
                >
                    <div class="flex items-center">
                        <p class="text-xs">
                            Updated By : {{ props.cit.created_by }}
                        </p>
                    </div>
...
watch(
    ...
    (newVal) => {
        ...
        if (newVal && props.cit) {
            form.sequence_no = props.cit.sequence_no;
            form.ci_type = props.cit.ci_type;
            form.nav_code = props.cit.nav_code;
...
const submit = () => {
    form.put(route("editChargeInvoiceType", props.cit.id), {
        onSuccess: () => {
