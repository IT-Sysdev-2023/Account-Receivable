            ...
            <form @submit.prevent="submit">
                ...
                >
                    <div class="flex items-center">
                        <p class="text-xs">
                            Updated By : {{ props.cab.created_by }}
                        </p>
                    </div>
...
watch(
    ...
    (newVal) => {
        ...
        if (newVal && props.cab) {
            form.bank_code = props.cab.bank_code;
            form.bank_name = props.cab.bank_name;
            form.address = props.cab.address;
            form.acc_code = props.cab.acc_code;
            form.acc_classification = props.cab.acc_classification;
...
const submit = () => {
    form.put(route("editCashInBank", props.cab.id), {
        onSuccess: () => {
            form.reset();
            emit("closeSuccess");
        },
