<template>
    <div>
        ...
        >
            <ConfirmationDialog
                :show="showDialog"
                message="Are you sure about deleting this adjustment?"
                @close="handleConfirm"
            />
        </Transition>
        ...
        >
            ...
            >
                <thead class="sticky top-0 z-10">
                    <tr>
                        ...
                        <th
                            class="px-3 py-2 w-[18%] text-left font-semibold tracking-wider"
                        >
                            ACC CODE
                        </th>
                        <th
                        ...
                        <th
                            class="px-3 py-2 w-[16%] text-left font-semibold tracking-wider"
                        >
                            TRANSACTION TYPE
                        </th>
                        <th
                ...
                <tbody v-else>
                    <tr
                        v-for="adjustment_reason_setup in adjustment_reason_setups.data"
                    ...
                    >
                        ...
                        <td class="px-4 py-2">
                            <span
                                ...
                                :title="adjustment_reason_setup.status"
                            >
            ...
            <!-- Pagination Links -->
            <div
                v-if="isLoading || adjustment_reason_setups.data.length === 0"
            />
            <div v-else>
