    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4 backdrop-blur-sm bg-black/60">
        <div
            ...
            <div class="relative p-6">
                ...
                <!-- Table -->
                <div class="rounded-xl bg-[var(--color-primary)]/20 backdrop-blur-sm overflow-hidden">
                    <div class="relative">
                        <div
                            ...
                            <table class="w-full text-[var(--color-text-primary)] text-sm">
                                ...
                                <tbody v-else class="rounded-xl">
                                    <tr v-for="(item, index) in filteredData" :key="index" @click="handleSelect(item)"
                                        :class="[
                                    ...
                                    <tr v-if="filteredData.length === 0">
                                        <td colspan="1" class="px-5 py-6 text-center">
                                            No data found
                                        </td>
                                    </tr>
                                </tbody>
